...
//=======싸우다=====================================================================
  ...
  const nameSubmit = async function(){
    ...
    if(inputValue===correctAnswer){
      ...
      //서버에 데이터 저장
      axios.post('http://localhost:3000/addPokemon',{id:pokemonData[0].id, name:correctAnswer,date:Date.now()})
      axios.post('http://localhost:3000/addCoin',{coinAmount:`${ballCount}`})
